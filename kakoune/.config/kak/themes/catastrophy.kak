...
# : line number cursor
face global SolLineNumberCursorNormal    "rgb:%opt{SolBackground},rgb:%opt{SolNormalAccent}+bg"
face global SolLineNumberCursorInsert    "rgb:%opt{SolBackground},rgb:%opt{SolInsertAccent}+bg"
face global SolLineNumberCursorPrompt    "rgb:%opt{SolBackground},rgb:%opt{SolPromptAccent}+bg"
# : primary cursor
face global SolPrimaryCursorNormal       "rgb:%opt{SolNormalAccent}+rbg"
face global SolPrimaryCursorInsert       "rgb:%opt{SolInsertAccent}+rbg"
face global SolPrimaryCursorPrompt       "rgb:%opt{SolPromptAccent}+rbg"
face global SolPrimaryCursorEolNormal    "rgb:%opt{SolNormalAccentLight}+rbg"
face global SolPrimaryCursorEolInsert    "rgb:%opt{SolInsertAccentLight}+rbg"
face global SolPrimaryCursorEolPrompt    "rgb:%opt{SolPromptAccentLight}+rbg"
# : secondary cursor
face global SolSecondaryCursorNormal     "rgb:%opt{SolNormalAccentLight}+rbg"
face global SolSecondaryCursorInsert     "rgb:%opt{SolInsertAccentLight}+rbg"
face global SolSecondaryCursorPrompt     "rgb:%opt{SolPromptAccentLight}+rbg"
face global SolSecondaryCursorEolNormal  "rgb:%opt{SolNormalAccentLight}+rbg"
face global SolSecondaryCursorEolInsert  "rgb:%opt{SolInsertAccentLight}+rbg"
face global SolSecondaryCursorEolPrompt  "rgb:%opt{SolPromptAccentLight}+rbg"
# : selections
...
face global Information        "rgb:%opt{_white},rgb:%opt{_black}"
face global Error              "rgb:%opt{_red},default+b" 
face global DiagnosticError    "default,rgb:%opt{_red}+b"
...
face global LineFlagHint           "rgb:%opt{_yellow}"
face global DiagnosticWarning      "default,default,rgb:%opt{_gray1}+c"
face global DiagnosticInfo         "default,default,rgb:%opt{_blue}+c"
face global DiagnosticHint         "default,default,rgb:%opt{_yellow}+c"
# : info boxes
face global InfoDefault "rgb:%opt{_white}"
face global InfoBlock "rgb:%opt{_dblue}"
face global InfoBlockQuote "rgb:%opt{_dblue}"
face global InfoBullet "rgb:%opt{_dblue}"
face global InfoHeader "rgb:%opt{_blue}"
face global InfoLink "rgb:%opt{_blue}"
face global InfoLinkMono "rgb:%opt{_dblue}"
face global InfoMono "rgb:%opt{_dblue}"
face global InfoRule "rgb:%opt{_dblue}"
face global InfoDiagnosticError "rgb:%opt{_dred}"
face global InfoDiagnosticHint "rgb:%opt{_dgreen}"
face global InfoDiagnosticInformation "rgb:%opt{_dgreen}"
face global InfoDiagnosticWarning "rgb:%opt{_yellow}"
